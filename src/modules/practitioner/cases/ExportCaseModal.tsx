          ...
          <div className="p-4 border border-border rounded-lg">
            ...
            <div className="space-y-2">
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  checked={contentToInclude.includes("audit-logs")}
                  onChange={() => handleContentToggle("audit-logs")}
                  className="rounded-full focus:ring-2 focus:ring-primary w-4 h-4 text-primary"
                />
                <span className="text-secondary text-sm">
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  checked={contentToInclude.includes("supervisor-comments")}
                  onChange={() => handleContentToggle("supervisor-comments")}
                  className="rounded-full focus:ring-2 focus:ring-primary w-4 h-4 text-primary"
                />
                <span className="text-secondary text-sm">
                  Supervisor Comments
            ...
            <div className="gap-4 grid grid-cols-2 mb-3">
              <div className="relative">
                <select
                  ...
                  className="bg-primary/5 px-3 py-2 border border-primary/5 focus:border-blue-500 rounded-lg outline-none focus:ring-2 focus:ring-blue-200 w-full text-accent text-sm appearance-none"
                >
                  <option value="from">From</option>
                  <option value="jan-5">Jan 5, 2024</option>
                  <option value="jan-8">Jan 8, 2024</option>
                  <option value="jan-15">Jan 15, 2024</option>
                </select>
              </div>
              <div className="relative">
                <select
